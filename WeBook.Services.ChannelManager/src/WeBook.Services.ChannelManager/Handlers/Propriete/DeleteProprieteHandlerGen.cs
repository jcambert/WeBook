...
namespace WeBook.Services.ChannelManager.Handlers
{
    ...
    public partial class DeleteProprieteHandler : DomainCommandHandler<DeletePropriete, Propriete,Guid>
    {
        ...
        public DeleteProprieteHandler(
            ...
            IMapper mapper, 
            IBrowseProprieteRepository repository) : base(busPublisher, mapper, repository)
        {
        }
        #endregion
        ...
        protected override async Task<bool> CheckExist(Guid id)
        {
            ...
            {
                throw new MicroSException("propriete_not_found",$"Propriete: '{id}'  was not found.");
            }
            return true;
        }
        #endregion
        ...
        /// <returns></returns>
        public override async Task HandleAsync(DeletePropriete command, ICorrelationContext context)
        {
            await base.HandleAsync(command, context);
            await Repository.DeleteAsync(command.Id);
            await BusPublisher.PublishAsync(CreateEvent<ProprieteDeleted>(command) , context);
