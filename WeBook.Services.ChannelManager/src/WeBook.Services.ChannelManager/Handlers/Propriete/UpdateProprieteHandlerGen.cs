...
namespace WeBook.Services.ChannelManager.Handlers
{
    ...
    public partial class UpdateProprieteHandler : DomainCommandHandler<UpdatePropriete, Propriete>
    {
        ...
        public UpdateProprieteHandler(
            ...
            IMapper mapper, 
            IBrowseProprieteRepository repo) : base(busPublisher, mapper, repo)
        {
        }
        #endregion
        ...
        protected override async Task<bool> CheckExist(Guid id)
        {
            ...
            {
                throw new MicroSException("propriete_not_found",$"Propriete with id: '{id}' was not found.");
            }
            return true;
        }
        #endregion
        ...
        /// <returns></returns>
        public override async Task HandleAsync(UpdatePropriete command, ICorrelationContext context)
        {
